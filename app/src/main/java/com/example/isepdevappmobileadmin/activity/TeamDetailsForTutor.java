...
public class TeamDetailsForTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.team_details_for_tutor);

        // We create the activity due to the user clicking the ProfilePage Image Button
        ImageButton profileImageButton = findViewById(R.id.profile_image_button_for_tutor_in_students_list_with_team_observations);
        ...
        ImageButton previousPageImageButton = findViewById(R.id.back_to_tutor_menu_from_team_details_page);
        previousPageImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentPreviousPage = new Intent(getApplicationContext(), TutorActivity.class);
        ...
        ListView listViewMenuItemTeamName = findViewById(R.id.team_name_for_tutor_in_students_list);
        String teamName = TutorActivity.TEAM_NAME;
        ...
        ListView studentsListView = findViewById(R.id.list_of_students_in_selected_group_for_tutor_list_view);
        ...
        for (int teamObservationIndex = 0; teamObservationIndex < allTeamObservationsInDB.size(); teamObservationIndex++) {
            if (allTeamObservationsInDB.get(teamObservationIndex).getTeamId() == teamId) {
                for (int skillIndex = 0; skillIndex < allSkillsInDB.size(); skillIndex++) {
                    if (allSkillsInDB.get(skillIndex).getComponentId() == TutorActivity.COMPONENT_ID
                            && allSkillsInDB.get(skillIndex).getId() == allTeamObservationsInDB.get(teamObservationIndex).getSkillId()) {
        ...
        studentsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intentStudentDetails = new Intent(getApplicationContext(), StudentDetailsForTutor.class);
